...
export const products: Product[] = [
  {
    ...
    features: ["5.2L stoneware bowl", "10 speed settings", "Tilt-head construction", "Two-year atelier care"], stock: 8, colors: ["Copper", "Oat", "Espresso"], sizes: ["5.2L", "6.5L"], featured: true, deal: true,
  },
  {
    id: "faro-espresso",
    ...
    features: ["15-bar pressure", "Integrated steam wand", "Single and double baskets", "Removable brass drip tray"], stock: 4, colors: ["Burnished copper", "Ink"], sizes: [], featured: true,
  },
  {
    id: "brine-oven",
    ...
    features: ["Six cooking modes", "Fits a 9-inch pan", "Dual quartz heat", "Crumb tray included"], stock: 13, colors: ["Brass", "Cream"], sizes: ["Compact", "Full-size"], featured: true, deal: true,
  },
  {
    id: "soma-processor",
    ...
    features: ["1.8L work bowl", "Pulse precision", "Three steel discs", "Dishwasher-safe parts"], stock: 5, colors: ["Copper", "Fennel"], sizes: [], featured: true,
  },
  {
    id: "aura-kettle",
    ...
    features: ["40–100°C control", "Keep-warm mode", "Balanced gooseneck spout", "1L capacity"], stock: 21, colors: ["Oat", "Ink"], sizes: [], deal: true,
  },
  {
    id: "field-blender",
    ...
    features: ["2L thermal jar", "Six blade steel core", "Four program settings", "Sound-dampened base"], stock: 2, colors: ["Espresso", "Cream"], sizes: [], featured: true,
  },
  {
    id: "linden-grill",
    ...
    features: ["Cast grill plate", "Precise temperature dial", "Low-smoke tray", "Indoor-safe design"], stock: 10, colors: ["Brass", "Ink"], sizes: [], deal: true,
  },
  {
    id: "flint-toaster",
    ...
    features: ["Four shade settings", "Long-slot design", "Lift-and-look lever", "Crumb tray"], stock: 18, colors: ["Copper", "Oat"], sizes: [],
  },
  {
    ...
    features: ["Set of four", "280ml capacity", "Stoneware body", "Dishwasher-safe"], stock: 24, colors: ["Oat", "Moss"], sizes: [],
  },
  {
    ...
    features: ["Set of six", "26cm diameter", "Low-rim profile", "Stack-friendly"], stock: 18, colors: ["Milk", "Clay"], sizes: [],
  },
  {
    ...
    features: ["Set of six", "Brushed stainless steel", "Dessert and serving size", "Hand-wash recommended"], stock: 31, colors: ["Brass"], sizes: [],
  },
  {
    ...
    features: ["3.2L capacity", "Hand-finished glaze", "Wide sharing profile", "Food-safe stoneware"], stock: 12, colors: ["Terracotta", "Oat"], sizes: [],
  },
];
...
export const coupons: Coupon[] = [
  ...
  { id: "countership", code: "COUNTERSHIP", type: "free_shipping", value: 0, minSpend: 80, usageLimit: null, uses: 31, expiresAt: "2026-12-31", active: true },
  { id: "mixer-only", code: "MIXERLOVE", type: "percent", value: 15, minSpend: 0, usageLimit: 50, uses: 3, expiresAt: "2026-12-31", productIds: ["morrow-mixer"], active: true },
];

export const campaigns: Campaign[] = [];

export const orders: Order[] = [
  { id: "CK-18042", createdAt: "2026-08-15T10:30:00.000Z", status: "preparing", lines: [{ productId: "morrow-mixer", quantity: 1, color: "Copper", size: "5.2L", name: "Morrow Stand Mixer", price: 429, image: hero }], subtotal: 429, discount: 42.9, shipping: 0, total: 386.1, couponCode: "COPPER10", customerName: "Maya O’Neil", customerEmail: "maya@example.com", address: "41 Alder Street, Portland, OR 97205", fulfillment: "delivery" },
  { id: "CK-18031", createdAt: "2026-08-10T14:15:00.000Z", status: "delivered", lines: [{ productId: "aura-kettle", quantity: 1, color: "Oat", size: "", name: "Aura Variable Kettle", price: 149, image: espresso }], subtotal: 149, discount: 0, shipping: 18, total: 167, customerName: "Maya O’Neil", customerEmail: "maya@example.com", address: "41 Alder Street, Portland, OR 97205", fulfillment: "delivery" },
];
